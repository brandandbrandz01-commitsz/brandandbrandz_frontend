                ...
                >
                    {displayStack.map((tech, index) => (
                        ...
                        >
                            ...
                            {/* Icon Container */}
                            <div className="w-16 h-16 md:w-24 md:h-24 relative flex items-center justify-center bg-white/5 rounded-2xl border border-white/10 p-4 md:p-6 backdrop-blur-sm transition-colors duration-300 group-hover:border-white/30 group-hover:bg-white/10">
                                <img
                                    src={tech.icon}
                                    alt={tech.name}
